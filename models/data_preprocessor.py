...
class DataPreprocessor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        df["run_rating"] = df["run_rating"].apply(lambda x: Utils.encode_missing_value(x, -1))
        df["run_weightInKg"] = df["run_weightInKg"].apply(lambda x: Utils.encode_missing_value(x, -1))
